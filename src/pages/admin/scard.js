      ...
      <div className={styles.cardBody}>
        <div className={styles.infoGrid}>
          <div className={styles.infoItem}>
            ...
            <a href={`mailto:${student.email}`} className={styles.link}>
              {student.email}
            </a>
          </div>
          ...
          <div className={styles.infoItem}>
            ...
            <a href={`tel:${student.mobileno}`} className={styles.link}>
              {student.mobileno}
            </a>
          </div>
        ...
        {student.linkedin || student.github || student.leetcode || student.portfolio ? (
          <div className={styles.socialLinks}>
            ...
            <div className={styles.linkContainer}>
              {student.linkedin && (
                <a href={student.linkedin} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              ...
              {student.github && (
                <a href={student.github} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              ...
              {student.leetcode && (
                <a href={student.leetcode} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              ...
              {student.portfolio && (
                <a href={student.portfolio} target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#4f8ef7">
                    <path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z" />
                  </svg>
                  Portfolio
        ...
        {student.resume && (
          <div className={styles.resumeSection}>
            <a href={student.resume} target="_blank" rel="noopener noreferrer" className={styles.resumeButton}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#4f8ef7">
              ...
              <div className={styles.list}>
                {student.projects.map((project, index) => (
                  <div key={index} className={styles.listItem}>
                    <h5 className={styles.itemTitle}>{project.title}</h5>
